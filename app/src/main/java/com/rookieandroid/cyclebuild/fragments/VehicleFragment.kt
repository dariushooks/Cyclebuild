...
import com.rookieandroid.cyclebuild.architecture.VehicleViewModel
...
class VehicleFragment : Fragment(R.layout.fragment_vehicle), View.OnClickListener
{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?)
    {
        ...
        homeViewModel.getInstalledParts().observe(viewLifecycleOwner) {p ->
            parts.clear()
            parts.addAll(p)
            adapter.notifyDataSetChanged()
        }

        homeViewModel.findInstalledParts(vehicle)
    }
